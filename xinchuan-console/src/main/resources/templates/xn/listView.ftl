...
<div id="vueApp" class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/xn/listView" method="get" id="pageForm">
           <input class="layui-input" placeholder="开始日" name="startTime" value="${seracheForm.startTime!""}" id="startTime">
            <input class="layui-input" placeholder="截止日" name="endTime" id="endTime" value="${seracheForm.endTime!""}">
            <input type="text" name="title" placeholder="新闻标题" value="${seracheForm.title!""}" autocomplete="off" class="layui-input">
