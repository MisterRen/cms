...
<div class="x-body">
    <form class="layui-form" id="prodect">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="createTime" value="${product.createTime}" name="createTime" required lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="prodectName" class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="level"  class="layui-input"  value="${product.level}"  id="level" min="1" max="7">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_repass" class="layui-form-label">
            </label>
            <button class="layui-btn"  onclick="update()" id="dynamicUpdate">
                修改
            </button>
