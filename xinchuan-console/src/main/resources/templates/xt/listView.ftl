...
<div class="x-body">
    <form class="layui-row" action="/teamManager/findAll" method="get" id="pageForm">
        <div class="layui-form layui-col-md12 x-so">
            <input class="layui-input" placeholder="开始日" name="startTime" id="startTime" value="${seracheForm.startTime!""}">
